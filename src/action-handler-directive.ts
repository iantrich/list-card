...
customElements.define('action-handler-list', ActionHandler);

const geActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-list')) {
    return body.querySelector('action-handler-list') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-list');
